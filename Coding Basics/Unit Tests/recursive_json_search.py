# Datos de ejemplo para el test unitario
"""Lo que se busca probar es si, al enviar un key y un JSON object como parámetro de entrada a una función,
esta retorna los key/value pairs encontrados en el JSON."""

key1 = "issueSummary"       # -> Este key sí existe en el JSON.
key2 = "XY&^$#*@!1234%^&"   # -> Este key no existe.
...
# Crear la función de búsqueda recursiva de los keys dentro del archivo
